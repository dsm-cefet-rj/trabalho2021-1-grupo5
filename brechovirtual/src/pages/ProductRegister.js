        ...
        <>
            ...
            <div class="container">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="form-control" id="validationTooltip01" placeholder="Título do anúncio" value="" required/>
            ...
            <div class="row">  
                <div class="col-4 d-flex justify-content-end">
                    <Button style={{backgroundColor: "#ccb5f7"}} title={"Publicar"}/> 
                </div>
                <div class="col-4 d-flex justify-content-end">
                <Button style={{backgroundColor: "#ccb5f7"}} title={"Cancelar"}/> 
                </div>
            </div>
