      ...
      <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" onSubmit={handleSubmit(onSubmit)}>
                ...
                <input type="text" id="nome" class="form-control" placeholder="E-mail" name="username" defaultValue={User.username}
                    required autofocus/>
                <input type="password" id="senha" class="form-control" placeholder="Senha" name="password" defaultValue={User.password}
                   required/>
                ...
                <button class="btn btn-primary btn-signin" type="submit" onClick={(e) => cancelButton(e)} >Cancelar</button>
            </form>
        </div>
    </div>
