...
const initialBookings = bookingsAdapter.getInitialState({
  ...
  export const  addBookingServer = createAsyncThunk('database/addBookingServer',
  async (booking)=>{
     return await httpPost(`${baseUrl}/bookings`,booking)
  } )
  export const deleteBookingServer = createAsyncThunk('database/deleteBooking',
    async (id)=>{
      await httpDelete(`${baseUrl}/bookings/${id}`)
      return id;
    })
    export const updateBookingServer = createAsyncThunk('database/updateBookingServer',
    async (booking)=>{
...
export const {
  ...
  selectTotal: selectBookingsTotal,} = bookingsSelector
